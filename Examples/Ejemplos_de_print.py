...
print("Imprimir dos variables con format {0},{1}, y {otro}".format(
    a, b, otro="gato"))
...
# Retorna la posición en donde se encuentra el string, despues de esa posición
print(a.find("a", 4))
print(a.find("o", 4))
...
# Validar si una palabra no existe en la cadena inicial
